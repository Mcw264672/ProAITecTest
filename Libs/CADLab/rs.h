...
//draw pixel tolerance
#define RS_TOLERANCE_PIX 1.0
#define RS_TOLERANCE_PIX_TOOSMALL 0.5
...
public:
    ...
    enum EntityType {
        ...
        EntityDimCircleCenter,  /** Circle Center Dimension */
        EntityDimPoint,     /** Point Dimension */
        EntityArrow,        /** Arrow **/
    ...
    enum ActionType {
        ...
        ActionDrawEllipseAxisEndP,
        ActionDrawEllipticalArc,
        ...
        ActionModifyArray,
        ActionModifySnapper,
        ActionModifySetTextAttribute,

        ActionModifyAttributes,
        ActionModifyAttributesNoSelect,
        ActionModifyChamfer,
        ActionModifyCopy,
        ActionModifyCurvyMeasure,
        ActionModifyCurvyMeasureNoSelect,
        ActionModifyDelete,
        ...
        ActionModifyErase,
        ActionModifyFillet,
		ActionModifyFilletNew,
		ActionModifyDiscrete,
		ActionModifyJoin,
        ActionModifyExtend,
        ActionModifyLengthen,
        ActionModifyMove,
        ...
        ActionModifyCut,
        ActionModifyStretch,
		ActionModifyStretchNew,
        ActionModifyBevel,
        ActionModifyBreak,
        ActionModifyBreakAtPoint,
        ActionModifyRound,
        ActionModifyOffset,
        ActionModifyOffsetNoSelect,
        ActionModifyEditPolyline,
        ActionModifyEditSpline,
        ActionModifyBlend,
        ...
        ActionBlocksImport,
        ActionBlocksInsertWidgetOpen,
        ActionBlocksInsertNew,

        ActionComponentsRemoveAll,
        ActionComponentsSelectAll,
        ACtionComponentDisSelectAll,
        ActionNestingInsert,
...
*/
    ...
    enum PaperFormat {
        ...
        enum RedrawMethod {
                ...
                RedrawRTrace = 8,
                RedrawBaseMap = 16,
                RedrawGlobalCAMPre = 32,
                RedrawGlobalCAMPost = 64,
                RedrawAll = 0xffff
        };
